...
# DFredin, 2022-Dec-10, Modified file to handle tracks on CDs and handle lists of files
#------------------------------------------------------#
...
class ScreenIO:
    ...
    def print_menu():
        ...
        print('[c] Choose CD / Album to add tracks\n[r] Remove entire CD / Album\n[s] Save Inventory to file\n[x] Exit\n') 
    ...
    def menu_choice():
        ...
        Returns:
            choice (string): a lower case sting of the users input out of the choices l, a, d, c, r, s or x
